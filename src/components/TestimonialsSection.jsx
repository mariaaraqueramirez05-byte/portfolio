...
export default function TestimonialsSection() {
  return (
    <section id="testimonios" className="py-24 px-6 bg-cream-50">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-cream-200/50 text-center"
        >
          <svg className="w-10 h-10 text-earth-300 mx-auto mb-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-earth-600/90 text-lg leading-relaxed mb-8 italic">
            "{testimonials[0].text}"
          </p>
          <div>
            <p className="font-serif text-lg text-earth-800">{testimonials[0].author}</p>
            <p className="text-sm text-earth-400 mt-1">{testimonials[0].role}</p>
          </div>
        </motion.div>
      </div>
    </section>
